...
_REFINE_PREPROMPT = (
    ...
    "Today is {today}.\n\n"
    "Rules:\n"
    "1. For vague time references (\"this week\", \"today\", \"latest\", "
    "\"current\", \"now\", \"recently\", \"upcoming\"), KEEP the word AND "
    "also append the month and year from today's date. Both signals "
    "improve search ranking — \"this week\" biases toward current "
    "fixtures/news pages, the explicit date scopes the year.\n"
    "2. Fix typos.\n"
