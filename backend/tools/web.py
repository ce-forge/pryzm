...
WEB_SEARCH_DIRECTIVE = (
    ...
    "For comparison questions (\"which is better, A or B\", \"compare A and B\", "
    "\"A vs B\"), issue SEPARATE web_search calls — one per entity — rather "
    "than a single combined query. Each entity then surfaces its canonical "
    "source (wiki, docs, spec page), and you can reason about the comparison "
    "from authoritative data rather than relying on whether a third-party "
    "\"A vs B\" article happens to exist.\n"
