...
class PromptManager:
    ...
    def load_prompts(self):
        if os.path.exists(DEFAULT_PROMPTS_FILE):
            ...
            raise FileNotFoundError("CRITICAL: micro_prompts.default.json is missing! Cannot start engine.")
    ...
    def __getitem__(self, key):
        return self.prompts.get(key, self.default_prompts.get(key, f"[Missing Prompt Configuration: {key}]"))
